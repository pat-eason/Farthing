...
- **2026-06-12**: Renamed to **Farthing** (name confirmed; BarTab declined): product/bundle identifiers, env overrides (`FARTHING_*`), UI strings, docs, plus a one-time data-dir migration from `com.peason.farthing`
