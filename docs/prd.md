...
- Project displayed as a cleaned path (e.g., `~/Projects/luxurypresence/websites`), grouped by directory.
...
| Project name | Low | "claude-usage-tracker" is a working name; pick a real name before public release (avoid collision with ccusage/CCSeva) |
